...
if(isset($_POST['submit']))
{
   ...
   $email=$_POST['email'];
    ...
    $query="INSERT INTO Non_health_care (checkbox,email) values ('$checkbox1','$email')";
    //$msg="qwerty";
...
<html lang="en">
   <head>
      ...
      <title>Global Unsubscribe</title>
         ...
         <div class="row">
            <div class="col-md-3">
               <div class="contact-info">
                  ...
                  <h2 style="color:#fff">Global Unsubscribe</h2>
               </div>
            </div>
            <div class="col-md-9">
               <form method="post" id="frmContactus" action="thanksNHC.php">
					<div class="contact-form">
					  ...
					  <div class="form-group">
						 ...
						 <div class="input-group mb-3" style="margin:30px; width:50%;">
