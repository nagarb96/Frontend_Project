<?php require_once("../config/config.php");$id_number=$_GET['id'];
$id_number=$_GET['id'];
?>
...
;
    ...
    margin-top: 30px;
    padding-bottom: 20px; /* Add padding at the bottom of the button container */
    }

    .btndiv button {
        width: 10%; /* Set button width to distribute space between buttons */
    }

    /* Add margin to the print button */
...
<body>
  ...
  <div class="btndiv">
    <button class="btn btn-warning"><a class="button edit" id="edit" href="update_form.php?id=<?php echo $id_number; ?>">Edit Form</a></button>
  ...
  <div class="cover"></div>
  <input type="checkbox" checked="checked"/> I / We the parents / guardians of <strong><?php echo $row['studentName'];?></strong> hereby register him/ her to be enrolled at Montessori Preschool in the year 20<span>23</span>. I / We understand that the $50.00 reservation fee is non refundable and will apply towards registration fee at time of enrollment.
</div>
      <div class="form-row">
