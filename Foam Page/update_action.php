...
// }
    ...
    $stmt->bindParam(':homePhone', $homePhone, PDO::PARAM_STR);
    $stmt->bindParam(':motherCellPhone', $motherCellPhone, PDO::PARAM_STR);
    $stmt->bindParam(':motherEmail', $motherEmail, PDO::PARAM_STR);
    $stmt->bindParam(':fatherCellPhone', $fatherCellPhone, PDO::PARAM_STR);
